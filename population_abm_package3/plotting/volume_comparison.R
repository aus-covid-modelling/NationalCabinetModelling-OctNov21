# Script to pull individual figures together for different arrivals volumes
# 
# 
# David J Price
# 22 October, 2021
...
if(isTRUE(baseline)){
  ggsave(paste0("./output_25Oct2021/volume_comparison_",the.state,"_baseline_arrivals_plot.png"), plot = p1, height = 6, width = 15, units = "in", bg = "white")
  ggsave(paste0("./output_25Oct2021/volume_comparison_",the.state,"_baseline_total_plot.png"), plot = p2, height= 6, width = 15, units = "in", bg = "white")
} else{
  ggsave(paste0("./output_25Oct2021/volume_comparison_",the.state,"_arrivals_plot.png"), plot = p1, height = 6, width = 15, units = "in", bg = "white")
  ggsave(paste0("./output_25Oct2021/volume_comparison_",the.state,"_total_plot.png"), plot = p2, height= 6, width = 15, units = "in", bg = "white")
}
